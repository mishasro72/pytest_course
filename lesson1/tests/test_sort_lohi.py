# автотест для проверки сортировки price Low - High на сайте https://www.saucedemo.com/
...
def test_sort_lohi():
    ...
    time.sleep(3)
    lohi_button=driver.find_element(By.XPATH, "//option[@value='lohi']") # находим кнопку сортировки по цене по возрастанию
    ...
    assert lst == sorted(lst) # проверяем равен ли список каталога отсортированному по возрастанию цены списку
    driver.quit()
