# автотест для проверки выхода из системы по нажатию кнопки logout на сайте https://www.saucedemo.com/
...
def test_log_out():
    ...
    time.sleep(3)
    logout_button = driver.find_element(By.XPATH, "//*[@id='logout_sidebar_link']")# гаходим кнопку выхода из системы
    logout_button.click()
