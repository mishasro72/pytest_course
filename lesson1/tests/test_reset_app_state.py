# автотест для проверки корректности работы вкладки reset App state на сайте https://www.saucedemo.com/
...
def test_log_out():
    ...
    time.sleep(3)
    app_button = driver.find_element(By.XPATH, "//*[@id='reset_sidebar_link']")# находим кнопку about в меню
    app_button.click()
